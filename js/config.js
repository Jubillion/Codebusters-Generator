...
export const CONFIG = {
    ...
    // List of ~200 keywords for cipher generation
    KEYWORD_LIST: [
        ...
        'BLAZING', 'CRIMSON', 'DYNAMIC', 'ECLIPSE', 'FLOURISH', 'GRANITE', 'HELIX', 'IMPULSE',
        'JASMINE', 'KALEIDOSCOPE', 'LIZARD', 'MAGNETIC', 'NIMBLE', 'OLIVE', 'PRISM', 'QUIVER',
        'RADIANT', 'SPIRAL', 'TURQUOISE', 'UPWARD', 'VELVET', 'WARDEN', 'ZEALOUS', 'BEACON',
        'CHARCOAL', 'DRUMBEAT', 'EXQUISITE', 'FLAMING', 'GUARDIAN', 'HARMONY', 'INFINITE', 'JOYFUL',
        'KINGDOM', 'LIBERTY', 'MYSTIC', 'NOBLE', 'OPULENT', 'PEACEFUL', 'QUICKSILVER', 'RADIANCE',
        'STERLING', 'TEMPEST', 'UNSTOPPABLE', 'VIBRANT', 'WANDERER', 'ZENOUS', 'ALCHEMY', 'BONFIRE',
        'CRYSTALLINE', 'DYNAMO', 'ENCHANTED', 'FEATHER', 'GLORIOUS', 'HUSHED', 'INSPIRE', 'JUKEBOX',
        'KINDRED', 'LUMINOUS', 'MEADOW', 'NURTURE', 'ODYSSEY', 'POETIC', 'QUARRY', 'RESILIENT',
        'SERENITY', 'TRIUMPH', 'ULTIMATE', 'VIVACIOUS', 'WONDER', 'ZEALOT', 'AZURE', 'BRILLIANT',
        'CASCADE', 'DESTINY', 'EUPHORIA', 'FORTRESS', 'GRACEFUL', 'HEROIC', 'IGNITE', 'JUBILANT',
        'KINETIC', 'LUSTROUS', 'MAJESTIC', 'NOCTURNE', 'OPTIMISM', 'PRISTINE', 'QUANTUM', 'RESOLUTE',
        'SPLENDOR', 'TRANSCEND', 'UNLIMITED', 'VALIANT', 'WHISPER', 'ZESTFUL', 'ARTISAN', 'BLISSFUL',
